...
for nonempty in [u'head', u'body', u'title', u'div', u'nav',
                 u'style', u'script',
    ...
    def nonemptyfunc(clist=[], attrs={}, elem=nonempty):
        if isinstance(clist, (str,unicode,)):
            clist = [clist]
        return(u'<' + elem + attrlist(attrs) + u'>'
                + u'\n'.join(clist) + u'</' + elem + u'>')
...
def emptypage():
    return html([
           ...
           link(attrs={u'href':u'https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta3/dist/css/bootstrap.min.css',
                       u'integrity':u'sha384-eOJMYsd53ii+scO/bJGFsiCZc+5NDVN2yr8+0RDqr0Ql0h+rP48ckxlpbzKgwra6',
                       u'crossorigin':u'anonymous',
                       u'rel':u'stylesheet'}),
           link(attrs={u'href':u'https://cdn.jsdelivr.net/npm/bootstrap-icons@1.4.0/font/bootstrap-icons.css',
                       u'rel':u'stylesheet'}),
                ],
                [u'__REPORT_NAV__',
